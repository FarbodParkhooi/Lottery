...
EntryOne=Entry(SelectNumbers,width=15,bg='#060624',fg='white')
EntryTwo=Entry(SelectNumbers,width=15,bg='#060624',fg='white')
EntryThree=Entry(SelectNumbers,width=15,bg='#060624',fg='white')
EntryFour=Entry(SelectNumbers,width=15,bg='#060624',fg='white')
EntryFive=Entry(SelectNumbers,width=15,bg='#060624',fg='white')
EntrySix=Entry(SelectNumbers,width=15,bg='#060624',fg='white')
# .pack(s) |and| .place(s):
