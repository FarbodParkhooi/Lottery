...
EntryOne=Entry(SelectNumbers,width=15)
EntryTwo=Entry(SelectNumbers,width=15)
EntryThree=Entry(SelectNumbers,width=15)
EntryFour=Entry(SelectNumbers,width=15)
EntryFive=Entry(SelectNumbers,width=15)
EntrySix=Entry(SelectNumbers,width=15)
# .pack(s) |and| .place(s):
